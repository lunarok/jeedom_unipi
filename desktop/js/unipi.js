...
$("#bt_addunipiInfo").on('click', function(event) {
    var _cmd = {type: 'info'};
    addCmdToTable(_cmd);
});

$("#bt_addunipiAction").on('click', function(event) {
